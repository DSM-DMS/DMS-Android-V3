...
class ApplyGoingEditActivity: DataBindingActivity<dsm.android.v3.databinding.ActivityApplyGoingEditBinding>(), ApplyGoingEditContract{
    ...
    override fun setErrorApplyGoingGoDate() { applyGoing_edit_going_date_edit.error = "MM/dd 형식에 맞게 입력하세요." }

    override fun setErrorApplyGoingGoTime() { applyGoing_edit_going_time_edit.error = "hh/mm ~ hh/mm 형식에 맞게 입력하세요." }
